...
{
	public static void calcAmazon(String inputItemNumber, double inputPurchasePrice, double inputMarge, double inputShippingCostNet, double itemVAT)
	{
		double marketplaceChargePercent = 1.12;
		double marketplaceChargeValue = 0.35;
