...
/*****************************************************
 ...
 void close()  // zum Schlie�en des BufferedReaders

 Folgende Instanz-Methode sind implementiert:
 void finalize()	// zum Schlie�en des BufferedReaders
...
public class In{
	...
	public static char readChar() {
		...
		if (inputSteam != null) { // Erzeugung �berpr�fen
			try {
			...
			System.out.println("Es konnte nichts eingelesen werden! R�ckgabewert 0!");
			return '0';
		}
	}
	...
	public static int readInt() {
		...
		if (inputSteam != null) { // Erzeugung �berpr�fen
			try {
				...
				// Eingabe-Streams wieder schlie�en
	...
	protected void finalize() throws Throwable {
		...
		// Eine verwendetet tempor�rer Datei l�schen 
		// Wenn die Datei nicht existiert oder tempfile null ist,
		// dann kann dies eine Ausnahme ausl�sen, s. throws
		inputSteam.close();
	}
